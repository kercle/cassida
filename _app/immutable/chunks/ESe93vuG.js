...
let Z, Q, m;
let __tla = (async () => {
  const W = /* @__PURE__ */ Symbol("is custom element"), U = /* @__PURE__ */ Symbol("is html"), I = A ? "link" : "LINK";
  Q = function(e) {
    if (h) {
      var t = false, n = () => {
        if (!t) {
  ...
  const B = "" + new URL("../assets/kernel_bg.BbmsgMvW.wasm", import.meta.url).href, O = async (e = {}, t) => {
    let n;
