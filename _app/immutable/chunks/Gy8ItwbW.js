...
const x = ((_a = globalThis.__sveltekit_1xlqjbz) == null ? void 0 : _a.base) ?? "/toy-cas", Lt = ((_b = globalThis.__sveltekit_1xlqjbz) == null ? void 0 : _b.assets) ?? x ?? "", At = "1772985874350", We = "sveltekit:snapshot", Fe = "sveltekit:scroll", Ge = "sveltekit:states", Ut = "sveltekit:pageurl", z = "sveltekit:history", F = "sveltekit:navigation", C = { tap: 1, hover: 2, viewport: 3, eager: 4, off: -1, false: -1 }, xe = location.origin;
function Ye(e) {
...
const Ct = /* @__PURE__ */ new Set(["icon", "shortcut icon", "apple-touch-icon"]), j = Be(Fe) ?? {}, Y = Be(We) ?? {}, $ = { url: De({}), page: De({}), navigating: be(null), updated: Tt() };
function Ae(e) {
  j[e] = q();
}
function Nt(e, t) {
  ...
  history.scrollRestoration = "manual", addEventListener("beforeunload", (t) => {
    ...
    if (!ye) {
      if ((_a4 = t.state) == null ? void 0 : _a4[z]) {
        const n = t.state[z];
        if (N = {}, n === v) return;
        const a = j[n], r = t.state[Ge] ?? {}, i = new URL(t.state[Ut] ?? location.href), o = t.state[F], s = _.url ? de(location) === de(_.url) : false;
        if (o === R && (nt || s)) {
