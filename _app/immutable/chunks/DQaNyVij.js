...
let Z, Q, m;
let __tla = (async () => {
  const U = /* @__PURE__ */ Symbol("is custom element"), B = /* @__PURE__ */ Symbol("is html"), W = v ? "link" : "LINK";
  Q = function(e) {
    if (h) {
      var t = false, n = () => {
        if (!t) {
  ...
  const k = "" + new URL("../assets/kernel_bg.BtFUHBBi.wasm", import.meta.url).href, O = async (e = {}, t) => {
    let n;
  ...
  let w = 0;
  function j(e, t) {
    return w += t, w >= H && (b = new TextDecoder("utf-8", {
      ignoreBOM: true,
      fatal: true
