...
window.fetch = (e, t) => ((e instanceof Request ? e.method : (t == null ? void 0 : t.method) || "GET") !== "GET" && F.delete(xe(e)), wt(e, t));
...
function Rt({ nodes: e, server_loads: t, dictionary: n, matchers: a }) {
  const r = new Set(t);
  return Object.entries(n).map(([s, [c, l, f]]) => {
    const { pattern: h, params: w } = kt(s), u = { id: s, exec: (p) => {
      const _ = h.exec(p);
      if (_) return xt(_, w, a);
...
const R = ((_a = globalThis.__sveltekit_xm5ucx) == null ? void 0 : _a.base) ?? "/cassidoid", Lt = ((_b = globalThis.__sveltekit_xm5ucx) == null ? void 0 : _b.assets) ?? R ?? "", At = "1773353107360", Ge = "sveltekit:snapshot", We = "sveltekit:scroll", Ye = "sveltekit:states", Ut = "sveltekit:pageurl", K = "sveltekit:history", W = "sveltekit:navigation", j = { tap: 1, hover: 2, viewport: 3, eager: 4, off: -1, false: -1 }, Re = location.origin;
function ze(e) {
...
function me(e, t, n) {
  ...
  const r = e instanceof SVGAElement ? e.target.baseVal : e.target, i = !a || !!r || le(a, t, n) || (e.getAttribute("rel") || "").split(/\s+/).includes("external"), o = (a == null ? void 0 : a.origin) === Re && e.hasAttribute("download");
...
function le(e, t, n) {
  return e.origin !== Re || !e.pathname.startsWith(t) ? true : n ? e.pathname !== location.pathname : false;
}
function rn(e) {
}
...
async function Ze() {
  if ("serviceWorker" in navigator) {
    const e = await navigator.serviceWorker.getRegistration(R || "/");
    e && await e.update();
  }
}
function Ve() {
...
let m = { branch: [], error: null, url: null }, tt = false, oe = false, Ke = true, J = false, M = false, nt = false, Te = false, at, v, x, N;
const se = /* @__PURE__ */ new Set(), Be = /* @__PURE__ */ new Map();
async function ln(e, t, n) {
  var _a3, _b2, _c2, _d2, _e6;
  ((_a3 = globalThis.__sveltekit_xm5ucx) == null ? void 0 : _a3.data) && globalThis.__sveltekit_xm5ucx.data, document.URL !== location.href && (location.href = location.href), y = e, await ((_c2 = (_b2 = e.hooks).init) == null ? void 0 : _c2.call(_b2)), Ue = Rt(e), I = document.documentElement, we = t, _e = e.nodes[0], ne = e.nodes[1], _e(), ne(), v = (_d2 = history.state) == null ? void 0 : _d2[K], x = (_e6 = history.state) == null ? void 0 : _e6[W], v || (v = x = Date.now(), history.replaceState({ ...history.state, [K]: v, [W]: x }, ""));
  const a = C[v];
  function r() {
...
async function st(e, t, n) {
  ...
  if (a && a.remove(), Object.assign(k, e.props.page), at = new y.root({ target: t, props: { ...e.props, stores: $, components: re }, hydrate: n, sync: false }), await Promise.resolve(), ot(x), n) {
...
function zt(e) {
  return pt(y.hash ? e.hash.replace(/^#/, "").replace(/[?#].+/, "") : e.pathname.slice(R.length)) || "/";
}
function ce(e) {
...
async function B({ type: e, url: t, popped: n, keepfocus: a, noscroll: r, replace_state: i, state: o = {}, redirect_count: s = 0, nav_token: c = {}, accept: l = Ve, block: f = Ve, event: h }) {
  ...
  let d = u && await it(u);
  if (!d) {
    if (le(t, R, y.hash)) return await H(t, i);
  ...
  if (qt(), Ae(_), rt(g), d.props.page.url.pathname !== t.pathname && (t.pathname = d.props.page.url.pathname), o = n ? n.state : o, !n) {
    const b = i ? 0 : 1, Q = { [K]: v += b, [W]: x += b, [Ye]: o };
    (i ? history.replaceState : history.pushState).call(history, Q, "", t), i || Nt(v, x);
  }
  ...
  !a && !ft && en(t, !P), Ke = true, d.props.page && Object.assign(k, d.props.page), J = false, e === "popstate" && ot(x), p.fulfil(void 0), p.navigation.to && (p.navigation.to.scroll = D()), G.forEach((b) => b(p.navigation)), $.navigating.set(Y.current = null);
}
async function lt(e, t, n, a, r) {
  return e.origin === Re && e.pathname === location.pathname && !tt ? await Pe({ status: a, error: n, url: e, route: t }) : await H(e, r);
}
function Ht() {
  ...
  async function i(s, c) {
    ...
    if (!l || f) return;
    const { url: h, external: w, download: u } = me(l, R, y.hash);
    if (w || u) return;
  ...
  function o() {
    ...
    for (const s of I.querySelectorAll("a")) {
      const { url: c, external: l, download: f } = me(s, R, y.hash);
      if (l || f) continue;
      const h = te(s);
...
function Xt() {
  ...
  history.scrollRestoration = "manual", addEventListener("beforeunload", (t) => {
    ...
    if (!n) return;
    const { url: a, external: r, target: i, download: o } = me(n, R, y.hash);
    if (!a) return;
    if (i === "_parent" || i === "_top") {
    ...
    M && (M = false, history.replaceState({ ...history.state, [K]: ++v, [W]: x }, "", location.href));
  });
