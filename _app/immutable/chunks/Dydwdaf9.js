...
const jt = /* @__PURE__ */ new Set(["icon", "shortcut icon", "apple-touch-icon"]), C = Me(Ge) ?? {}, Y = Me(Fe) ?? {}, $ = { url: De({}), page: De({}), navigating: be(null), updated: Tt() };
function Ae(e) {
  C[e] = q();
}
function Nt(e, t) {
