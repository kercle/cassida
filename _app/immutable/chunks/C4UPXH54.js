...
async function it({ id: e, invalidating: t, url: n, params: a, route: r, preload: i }) {
  ...
  const f = m.url ? e !== le(m.url) : false, h = m.route ? r.id !== m.route.id : false, w = Wt(m.url, n);
  let u = false;
